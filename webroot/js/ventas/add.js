...
function agregarDetalle(producto,keyword){
    ...
    var myPrecioSelect =  $("<select>")
                            ...
                            .append($('<option>', {value:producto.preciopack1, text:'Lista 1'}))
                            .append($('<option>', {value:producto.preciopack2, text:'Lista 2'}))
                            .append($('<option>', {value:producto.preciopack3, text:'Lista 3'}))
                            .append($('<option>', {value:producto.preciopack4, text:'Lista 4'}))
                            ;
    $("#fsDetalles").append(
        $('<div>')
            .attr('id','divDetalleVenta0'+numDetalle)
